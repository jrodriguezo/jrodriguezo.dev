          ...
          Long, 1st person
            ...
            <div className="text-lg sm:text-2xl mt-5 mb-10">
              ...
              obsessed with clean code, SOLID principles and best practices.</li>
                <li className='mt-10'>If you got here but you didn't figure out anything, don't worry though. <span className='italic my-4 block text-gray-400'><span className="font-serif font-black text-gray-400 text-xl sm:text-3xl">“</span> My job is about writing text using
