...
const PoliceEddie = (props) => {
  ...
  const { handleScroll, handlePosition } = props;
  ...
  useFrame((frame) => {
    ...
    actions[names[0]].time =
      (actions[names[0]].getClip().duration * scroll.offset) / 1;
    group.current.position.z = scroll.offset * 5;
    handleScroll(scroll.offset);
    handlePosition(group.current.position);
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        ...
        >
          <group
            name="86818a2105fd457f956f9560fe6e0c87fbx"
            rotation={[Math.PI / 2, 0, 0]}
          >
            <group name="Object_2">
              <group name="RootNode">
                <group name="Object_4">
                  ...
                  <skinnedMesh
                    ...
                    material={materials.char_swatches_lit_m_006}
                    skeleton={nodes.Object_8.skeleton}
                  />
                  <skinnedMesh
                    name="Object_9"
                    geometry={nodes.Object_9.geometry}
                    material={materials.jimbo_m}
                    skeleton={nodes.Object_9.skeleton}
                  />
                  <skinnedMesh
                    name="Object_10"
                    geometry={nodes.Object_10.geometry}
                    material={materials.shield_m}
