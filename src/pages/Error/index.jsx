...
function PageNotFound() {
  return (
    <div className="p-5 flex flex-col mx-auto max-w-3xl sm:items-center min-h-screen">
      <p className="text-5xl opacity-90 mt-20 mb-10 sm:mb-0 text-red-400">PAGE NOT FOUND</p>
      <p className="text-xl  opacity-30 mb-20 tracking-widest hidden sm:block"><span className="px-2">·</span>ERROR 404<span className="px-2">·</span></p>
